...
export default function SettingsModal({
  ...
  function handleChange(e) {
    ...
    if (e.target.classList.contains("radio")) toggleIsSettingsOpen();
  }
    ...
    <form className="swap-settings-form" onSubmit={handleSubmit}>
      ...
      <div className="slippage-setting-container">
        ...
        <div className="slippage-setting-options">
          <div
            className="slippage-option radio"
            name="slippage"
            value={0.1}
          ...
          <input
            ...
            max={50.0}
            step="0.01"
            className="slippage-option custom"
            name="slippage"
            placeholder="1.00%"
            value={txSettings.slippageInput}
      ...
      <div className="deadline-setting-container">
        ...
        <div className="deadline-setting-input-container">
          <input
            type="number"
            className="deadline-setting-input"
            name="deadline"
            placeholder="20"
            value={txSettings.deadlineInput}
            onChange={handleChange}
          />
