...
export default function InputContainersWrapper({
  userBalances,
  setMaxFromAmount,
  fromAmount,
  handleChange,
  toggleIsTokenListModalOpen,
  fromTokenData,
  fromToken,
  toAmount,
  toToken,
    ...
    <>
      <div className="input-container from">
        ...
        <div className="amount-container">
          ...
          <div
            ...
            onClick={() => toggleIsTokenListModalOpen("from")}
          >
            <img
              className="curency-icon"
        ...
        <div className="input-container-footer main-container-footer">
          <p className="balance">
            Balance:{" "}
            {fromTokenData.data
              ? `~${parseFloat(fromTokenData.data.formatted).toFixed(4)}`
              : "0.00"}
          </p>
        </div>
      </div>
      <div className="input-container to">
        ...
        <div className="amount-container">
          ...
          <div
            className="currency-dropdown"
            onClick={() => toggleIsTokenListModalOpen("to")}
          >
            <img
              className="curency-icon"
              src={toToken.logoURI}
        ...
        <div className="input-container-footer">
          <p className="balance">
            Balance:{" "}
            {toTokenData.data
              ? parseFloat(toTokenData.data.formatted).toFixed(4)
              : "0.00"}
          </p>
        </div>
      </div>
